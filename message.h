...
#define MB_HEADER_SIZE          6       /**< Минимальный размер сообщения ModbusTCP (размер заголовка сообщения) */
...
typedef struct {
    ...
    connection_t * src_connection;          ///< Параметры подключения, получившего сообщение
